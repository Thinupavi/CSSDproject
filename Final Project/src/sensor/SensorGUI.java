...
public class SensorGUI extends javax.swing.JFrame {
    ...
    public SensorGUI() 
    {
        ...
        File sensors = new File("Files/sensor.ser");
        ...
        if (!sensors.exists()){
           ...
           resetData();
            ...
            deserializeSensorsSet("Files/sensor.ser");
        }
    ...
    private void filterSensors(){
        ...
        Sensor sensor1  = new Sensor(0,"Heat Sensor Monitor","Active","200",null);
        Sensor sensor2  = new Sensor(1,"Traffic Sensor Monitor","NoActive","100",null);
        Sensor sensor3 = new Sensor(2,"Oxygen Sensor Monitor","Active","300",null);


        theSensors.addSensor(sensor1);
        theSensors.addSensor(sensor2);
        theSensors.addSensor(sensor3);
    }
    ...
    private void saveAll(){
        clearSelectedSensor();
        serializeSensorsSet("Files/sensor.ser");
        showChangesSaved();
    }
    ...
    public static void serializeSensorsSet(String fLoc){
        try
        {
    ...
    public static void deserializeSensorsSet(String fLoc)
    {
        //failsafe
            ...
            if (obj instanceof Vector)
            {
                ...
                for(int x = 0; x < eSensors.size(); x++){
                    Sensor eSen = new Sensor(eSensors.elementAt(x).getSensorNumber(),
                            ...
                            eSensors.elementAt(x).getSensormontior());
    ...
    private void initComponents() {
        ...
        jTxtSenIDInput.setDisabledTextColor(new java.awt.Color(255, 255, 255));
        ...
        btnAddSen.setBackground(new java.awt.Color(51, 102, 255));
        btnAddSen.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btnAddSen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8-plus-30.png"))); // NOI18N
        ...
        btnEditSen.setBackground(new java.awt.Color(51, 102, 255));
        btnEditSen.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btnEditSen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8-compose-30.png"))); // NOI18N
        ...
        btnDelSen.setBackground(new java.awt.Color(51, 51, 255));
        btnDelSen.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btnDelSen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8-delete-30.png"))); // NOI18N
        ...
        btnQuerySensors.setBackground(new java.awt.Color(51, 51, 255));
        btnQuerySensors.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btnQuerySensors.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icons8-search-30.png"))); // NOI18N
        btnQuerySensors.setText("  Search Sensors");
        ...
        jPanelContainerLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelContainerLayout.createSequentialGroup()
                ...
                .addGroup(jPanelContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanelContainerLayout.createSequentialGroup()
                        .addComponent(btnAddSen, javax.swing.GroupLayout.PREFERRED_SIZE, 177, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(btnEditSen, javax.swing.GroupLayout.PREFERRED_SIZE, 167, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(20, 20, 20)
                        .addComponent(btnDelSen))
                ...
                .addGroup(jPanelContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelContainerLayout.createSequentialGroup()
                        ...
                        .addGroup(jPanelContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(btnAddSen, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnDelSen, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(btnEditSen, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE))
                        ...
                        .addGroup(jPanelContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(btnQuerySensors, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(lblNoSenQResultsTxt))
                        .addGap(38, 38, 38)
                        .addGroup(jPanelContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lblChangesSaved)
                            .addGroup(jPanelContainerLayout.createSequentialGroup()
                                .addGap(5, 5, 5)
                                .addComponent(btnSaveChanges, javax.swing.GroupLayout.PREFERRED_SIZE, 49, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelContainerLayout.createSequentialGroup()
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btnQuit, javax.swing.GroupLayout.PREFERRED_SIZE, 54, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
    ...
    private void btnSenFormApplyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSenFormApplyActionPerformed
        ...
        if(!btnTxt.isEmpty() && !senName.trim().isEmpty() && !senStatus.trim().isEmpty() && !senFrequency.trim().isEmpty()){
            if (btnTxt.equals("Add")){ // btn txt == add
                Sensor sensor = new Sensor(theSensors.lastElement().getSensorNumber()+1,senName, senStatus,senFrequency,null);
