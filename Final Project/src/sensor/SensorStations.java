...
public class SensorStations implements Serializable,Subject
{
   ...
   // public Mothership observer;
    ...
    public SetOfSensors getSmonitors(){
        ...
        return currentsensors; //get current sensors to the station
    }
...
//    }
  ...
  public String toString()
    ...
    public void notifyObservers() {
     ...
     //     observer.update(StationID,Destination,NoofActiveSensors,Lattitude,Longitude);
      }      
    }

    void returnAllBOL() {
        currentsensors.removeAllElements(); //assign the sensor monitor to station
    }
